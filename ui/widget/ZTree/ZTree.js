LBF.define('ui.widget.ZTree.ZTree', function(require){
    var jQuery = require('lib.jQuery');

    require('{theme}/lbfUI/css/zTreeStyle.css');
/*
		...
		makeNodeIcoStyle: function(setting, node) {
			...
			if (!node.isAjaxing) {
				...
				if (icon) {
					...
					icoStyle.push("width:0;height:0;");
				}
				if (setting.view.showIcon == false || !tools.apply(setting.view.showIcon, [setting.treeId, node], true) || (node.children && node.children.length == 0 && node.isParent)) {
