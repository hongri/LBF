 ...
 */
LBF.define('ui.widget.DatePicker.DatePickerTemplate', function(){
    return [
                ...
                '<table class="lbf-date-picker-table">',
                    ...
                    '<tbody>',
                        ...
                        '<% for(var j=daysThisMonth; j--; cDate = nextDay(cDate)){ %>',
                            ...
                            '<tr>',
                            '<% } %>',
                                '<td data-date="<%== +cDate %>" class="lbf-date-picker-date <%== isHighlighted(cDate) ? "lbf-date-picker-date-highlight" : ""%> <%== isDayEnabled(cDate) ? "lbf-date-picker-date-enabled" : ""%> <%== isDaySelected(cDate) ? "lbf-date-picker-date-selected" : ""%>"><%== cDate.getDate() %></td>',
                                '<% if(day === 6){ %>',
                            '</tr>',
                        '<% } %>',
                    '<% } %>',
