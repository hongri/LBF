/**
 * @fileOverview Backbone library
 * @version 0.9.2
 * Created: 12-9-23 上午10:00
 */
...
/**
 * Backbone library focused on frontend MVC. See <a target="_blank" href="http://backbonejs.org/">backbonejs.org</a>
...
/** @ignore */
LBF.define('lib.Backbone', function(require, exports){
...
//     http://backbonejs.org
    ...
    (function(){
        ...
        var _ = root._;
        if (!_ && (typeof require !== 'undefined')) _ = require('lib.underscore');
        ...
        _.extend(History.prototype, Events, {
            ...
            getHash: function(window) {
                var match = (document.URL || (window || this).location.href).match(/#(.*)$/);
            ...
            navigate: function(fragment, options) {
                ...
                if (this._hasPushState) {
                    ...
                    if (this.iframe && (fragment !== this.getFragment(this.getHash(this.iframe)))) {
                        ...
                        this._updateHash(this.iframe.contentWindow.location, fragment, options.replace);
                    }
